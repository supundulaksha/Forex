<table cellpadding="0" cellspacing="0" border="0" class="display groceryCrudTable table-bordered table-hover order-column  table-header-fixed" id="<?php echo uniqid(); ?>" style="width: 100%;">
	<thead>
		<tr>
