...
function loadDataTable(this_datatables) {
	return $(this_datatables).dataTable({
		...
		"sDom": "<'row' <'col-md-12'B>><'row'<'col-md-6 col-sm-12'l><'col-md-6 col-sm-12'f>r><'table-scrollable't><'row'<'col-md-5 col-sm-12'i><'col-md-7 col-sm-12'p>>",
		//"sDom": 'B<"clear"><"H"lfr>t<"F"ip>',
        'buttons': [
