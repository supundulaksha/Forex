...
class Ion_auth_model extends CI_Model
{
     ...
     * @author    Mathew
     */
    public function register($identity, $password, $email, $additional_data = [], $stu, $groups = [])
    {
    ...
    public function users($groups = NULL)
    {
        ...
        $this->db->where($this->tables['users_groups'].'.group_id !=',4);
    ...
    //   change group id
    function add_to_groupup($grp , $id){
        $this->db->set('group_id', $grp);
